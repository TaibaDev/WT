                    ...
                    >
                        ...
                        >
                            <div className='w-full  md:w-[50%] bg-[#caf4ff8d]  h-full ' >
                                ...
                                <a href="#_" class="relative  md:px-4 py-2 font-medium group w-[150px]  mx-auto md:w-1/2 text-center mt-4 md:ml-4 pl-3 block">
                                    <span class="absolute  inset-0 w-full h-full transition duration-200 ease-out transform translate-x-1 translate-y-1 bg-[#FF165D] group-hover:-translate-x-0 group-hover:-translate-y-0"></span>
                                    <span class="absolute inset-0 w-full h-full bg-white border-2 border-[#FF165D] group-hover:bg-[#FF165D]"></span>
                                    <span class="relative text-[#FF165D] group-hover:text-white">Donate</span>
                                </a>
